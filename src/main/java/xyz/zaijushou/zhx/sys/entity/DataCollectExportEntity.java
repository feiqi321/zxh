 ...
 */
public class DataCollectExportEntity {
    ...
    private String residualPrinciple;
    ...
    public String getResidualPrinciple() {
        return residualPrinciple;
    }

    public void setResidualPrinciple(String residualPrinciple) {
