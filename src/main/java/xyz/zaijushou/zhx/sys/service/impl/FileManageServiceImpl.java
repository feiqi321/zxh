        ...
        for (int i=0;i<list.size();i++){
            ...
            if (StringUtils.isEmpty(dataCollectionEntity.getSeqno())){
                ...
                if (temp!=null){
                    ...
                    log.setType("电话催收");
                    log.setContext("联系人："+dataCollectionEntity.getTargetName()+"，电话号码："+dataCollectionEntity.getMobile()+"[手机]，通话内容："+(dataCollectionEntity.getCollectInfo()==null?"":dataCollectionEntity.getCollectInfo()));
