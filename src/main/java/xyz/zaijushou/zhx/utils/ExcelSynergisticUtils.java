...
@Component
public class ExcelSynergisticUtils {

    private static Logger logger = LoggerFactory.getLogger(ExcelSynergisticUtils.class);
        ...
        switch (cellType) {
            ...
            case NUMERIC:
                ...
                if (clazz.equals(Date.class)) {
                    ...
                    if (xyz.zaijushou.zhx.utils.StringUtils.notEmpty(col) && col.equals("*委案日期")){
                        try {
                            //获取单元格的时间格式
