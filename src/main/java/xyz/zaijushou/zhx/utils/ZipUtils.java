...
/**
 * Created by looyer on 2019/7/12.
 */
...
public class ZipUtils {
    ...
    public static void main(String[] args) {
        try {
            ZipOutputStream zipOutputStream = new ZipOutputStream(new FileOutputStream(new File("D:/detailFile/a.zip")));
            zipOutputStream.setEncoding(CHAR_SET);

            List<File> files = new ArrayList<File>();
            files.add(new File("D:/detailFile/1.xml"));
            files.add(new File("D:/detailFile/1eded35815e5428d9d9a9c06f798ed78.editorconfig"));
            files.add(new File("D:/detailFile/20e2dada33ce4c61a7aa910cfbdaf01f.gitignore"));
