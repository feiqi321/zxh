...
public enum CaseSortEnum {
    ...
    COLUMN10("money","da.money"),
    COLUMN11("balance","da.balance"),
    ...
    COLUMN17("proRepayAmt","da.pro_repay_amt"),
    COLUMN18("bankAmt","da.bank_amt"),
    COLUMN19("enRepayAmt","da.en_repay_amt"),
