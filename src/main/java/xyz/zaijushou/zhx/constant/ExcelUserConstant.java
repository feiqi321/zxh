...
public class ExcelUserConstant {
    ...
    public enum UserInfoExport implements ExcelEnum{
        ...
        COL40(40, "坐席号", "officePhone", String.class),
        COL50(50, "手机号", "mobile", String.class),
        COL60(60, "入职日期", "joinTime", Date.class),
        COL70(60, "下组日期", "actualTime", Date.class),
        COL80(70, "角色", "role", String.class),
        COL90(80, "部门", "department", String.class),
        ;
    ...
    public enum Dept implements ExcelEnum {
        COL10(10, "*部门", "downDept", String.class),
        COL20(20, "*上级部门", "upDept", String.class),
        ;
        ...
        Dept(Integer sort, String col, String attr, Class... attrClazz) {
            this.sort = sort;
            this.col = col;
            this.attr = attr;
            this.attrClazz = attrClazz;
