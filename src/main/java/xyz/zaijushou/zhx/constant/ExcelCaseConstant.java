...
public class ExcelCaseConstant {
    ...
    public enum CaseExportCaseConf {
        ...
        COL550("province", "省份", "0 as 'province.id'", SysDictionaryEntity.class, String.class),
        COL560("city", "城市", "0 as 'city.id'", SysDictionaryEntity.class, String.class),
        COL570("county", "区县", "0 as 'county.id'", SysDictionaryEntity.class, String.class),
        ...
        COL1330("totalOverdueMoney", "总欠款(委案金额+公司佣金)", "'' as totalOverdueMoney", String.class),
