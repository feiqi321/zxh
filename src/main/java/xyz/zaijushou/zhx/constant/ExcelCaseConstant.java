...
public class ExcelCaseConstant {
    ...
    public enum CaseExportCaseConf {
        ...
        COL770("contactsName0", "联系人1姓名", "'' as 'contacts[0].name'", DataCaseContactsEntity.class, String.class),
        COL780("contactsIdentNo0", "联系人1证件号", "'' as 'contacts[0].identNo'", DataCaseContactsEntity.class, String.class),
        COL790("contactsRelation0", "联系人1关系", "'' as 'contacts[0].relation'", DataCaseContactsEntity.class, String.class),
        COL800("contactsUnit0", "联系人1单位", "'' as 'contacts[0].unit'", DataCaseContactsEntity.class, String.class),
        COL810("contactsHomeTel0", "联系人1家庭电话", "'' as 'contacts[0].homeTel'", DataCaseContactsEntity.class, String.class),
        COL820("contactsUnitTel0", "联系人1单位电话", "'' as 'contacts[0].unitTel'", DataCaseContactsEntity.class, String.class),
        COL830("contactsMobile0", "联系人1手机", "'' as 'contacts[0].mobile'", DataCaseContactsEntity.class, String.class),
        COL840("contactsAddress0", "联系人1地址", "'' as 'contacts[0].address'", DataCaseContactsEntity.class, String.class),
        COL850("contactsName1", "联系人2姓名", "'' as 'contacts[1].name'", DataCaseContactsEntity.class, String.class),
        COL860("contactsIdentNo1", "联系人2证件号", "'' as 'contacts[1].identNo'", DataCaseContactsEntity.class, String.class),
        COL870("contactsRelation1", "联系人2关系", "'' as 'contacts[1].relation'", DataCaseContactsEntity.class, String.class),
        COL880("contactsUnit1", "联系人2单位", "'' as 'contacts[1].unit'", DataCaseContactsEntity.class, String.class),
        COL890("contactsHomeTel1", "联系人2家庭电话", "'' as 'contacts[1].homeTel'", DataCaseContactsEntity.class, String.class),
        COL900("contactsUnitTel1", "联系人2单位电话", "'' as 'contacts[1].unitTel'", DataCaseContactsEntity.class, String.class),
        COL910("contactsMobile1", "联系人2手机", "'' as 'contacts[1].mobile'", DataCaseContactsEntity.class, String.class),
        COL920("contactsAddress1", "联系人2地址", "'' as 'contacts[1].address'", DataCaseContactsEntity.class, String.class),
        COL930("contactsName2", "联系人3姓名", "'' as 'contacts[2].name'", DataCaseContactsEntity.class, String.class),
        COL940("contactsIdentNo2", "联系人3证件号", "'' as 'contacts[2].identNo'", DataCaseContactsEntity.class, String.class),
        COL950("contactsRelation2", "联系人3关系", "'' as 'contacts[2].relation'", DataCaseContactsEntity.class, String.class),
        COL960("contactsUnit2", "联系人3单位", "'' as 'contacts[2].unit'", DataCaseContactsEntity.class, String.class),
        COL970("contactsHomeTel2", "联系人3家庭电话", "'' as 'contacts[2].homeTel'", DataCaseContactsEntity.class, String.class),
        COL980("contactsUnitTel2", "联系人3单位电话", "'' as 'contacts[2].unitTel'", DataCaseContactsEntity.class, String.class),
        COL990("contactsMobile2", "联系人3手机", "'' as 'contacts[2].mobile'", DataCaseContactsEntity.class, String.class),
        COL1000("contactsAddress2", "联系人3地址", "'' as 'contacts[2].address'", DataCaseContactsEntity.class, String.class),
        COL1010("contactsName3", "联系人4姓名", "'' as 'contacts[3].name'", DataCaseContactsEntity.class, String.class),
        COL1020("contactsIdentNo3", "联系人4证件号", "'' as 'contacts[3].identNo'", DataCaseContactsEntity.class, String.class),
        COL1030("contactsRelation3", "联系人4关系", "'' as 'contacts[3].relation'", DataCaseContactsEntity.class, String.class),
        COL1040("contactsUnit3", "联系人4单位", "'' as 'contacts[3].unit'", DataCaseContactsEntity.class, String.class),
        COL1050("contactsHomeTel3", "联系人4家庭电话", "'' as 'contacts[3].homeTel'", DataCaseContactsEntity.class, String.class),
        COL1060("contactsUnitTel3", "联系人4单位电话", "'' as 'contacts[3].unitTel'", DataCaseContactsEntity.class, String.class),
        COL1070("contactsMobile3", "联系人4手机", "'' as 'contacts[3].mobile'", DataCaseContactsEntity.class, String.class),
        COL1080("contactsAddress3", "联系人4地址", "'' as 'contacts[3].address'", DataCaseContactsEntity.class, String.class),
        COL1090("contactsName4", "联系人5姓名", "'' as 'contacts[4].name'", DataCaseContactsEntity.class, String.class),
        COL1100("contactsIdentNo4", "联系人5证件", "'' as 'contacts[4].identNo'", DataCaseContactsEntity.class, String.class),
        COL1110("contactsRelation4", "联系人5关系", "'' as 'contacts[4].relation'", DataCaseContactsEntity.class, String.class),
        COL1120("contactsUnit4", "联系人5单位", "'' as 'contacts[4].unit'", DataCaseContactsEntity.class, String.class),
        COL1130("contactsHomeTel4", "联系人5家庭电话", "'' as 'contacts[4].homeTel'", DataCaseContactsEntity.class, String.class),
        COL1140("contactsUnitTel4", "联系人5单位电话", "'' as 'contacts[4].unitTel'", DataCaseContactsEntity.class, String.class),
        COL1150("contactsMobile4", "联系人5手机", "'' as 'contacts[4].mobile'", DataCaseContactsEntity.class, String.class),
        COL1160("contactsAddress4", "联系人5地址", "'' as 'contacts[4].address'", DataCaseContactsEntity.class, String.class),
        COL1170("contactsName5", "联系人6姓名", "'' as 'contacts[5].name'", DataCaseContactsEntity.class, String.class),
        COL1180("contactsIdentNo5", "联系人6证件", "'' as 'contacts[5].identNo'", DataCaseContactsEntity.class, String.class),
        COL1190("contactsRelation5", "联系人6关系", "'' as 'contacts[5].relation'", DataCaseContactsEntity.class, String.class),
        COL1200("contactsUnit5", "联系人6单位", "'' as 'contacts[5].unit'", DataCaseContactsEntity.class, String.class),
        COL1210("contactsHomeTel5", "联系人6家庭电话", "'' as 'contacts[5].homeTel'", DataCaseContactsEntity.class, String.class),
        COL1220("contactsUnitTel5", "联系人6单位电话", "'' as 'contacts[5].unitTel'", DataCaseContactsEntity.class, String.class),
        COL1230("contactsMobile5", "联系人6手机", "'' as 'contacts[5].mobile'", DataCaseContactsEntity.class, String.class),
        COL1240("contactsAddress5", "联系人6地址", "'' as 'contacts[5].address'", DataCaseContactsEntity.class, String.class),
        COL1250("remark0", "备注1", "'' as 'caseRemarks[0].remark'", DataCaseRemarkEntity.class, String.class),
        COL1260("remark1", "备注2", "'' as 'caseRemarks[1].remark'", DataCaseRemarkEntity.class, String.class),
        COL1270("remark2", "备注3", "'' as 'caseRemarks[2].remark'", DataCaseRemarkEntity.class, String.class),
        COL1280("remark3", "备注4", "'' as 'caseRemarks[3].remark'", DataCaseRemarkEntity.class, String.class),
        COL1290("remark4", "备注5", "'' as 'caseRemarks[4].remark'", DataCaseRemarkEntity.class, String.class),
        COL1300("remark5", "备注6", "'' as 'caseRemarks[5].remark'", DataCaseRemarkEntity.class, String.class),
