...
public class ExcelCaseConstant {
    ...
    public enum StandardCase implements ExcelEnum {
        ...
        COL670(670, "最后还款日", "lastRepayDate", String.class),
    ...
    public enum StandardCardLoanCase implements ExcelEnum {
        ...
        COL260(260,"担保人单位","contactUnit7",String.class),
        COL270(270,"担保人单位电话","contactUnitTel7",String.class),
        COL280(280,"担保人地址","contactAddress7",String.class),
        COL290(290,"担保人关系","contactRelation7",String.class),
        COL300(300,"担保人家庭电话","contactHomeTel7",String.class),
        COL310(310,"担保人手机","contactMobile7",String.class),
        COL320(320,"担保人姓名","contactName7",String.class),
        COL330(330,"担保人证件号","contactIdentNo7",String.class),
        ...
        COL1130(1130,"配偶单位","contactUnit8",String.class),
        COL1140(1140,"配偶单位电话","contactUnitTel8",String.class),
        COL1150(1150,"配偶地址","contactAddress8",String.class),
        COL1160(1160,"配偶家庭电话","contactHomeTel8",String.class),
        COL1170(1170,"配偶手机","contactMobile8",String.class),
        COL1180(1180,"配偶姓名","contactName8",String.class),
        COL1190(1190,"配偶证件号","contactIdentNo8",String.class),
        ...
        COL1700(1700,"最后还款日","lastRepayDate",String.class),
    ...
    public enum CaseExportCase implements ExcelEnum {
        ...
        COL180(180, "委案日期", "caseDate", Date.class),
        ...
        COL310(310, "最后通电", "collectDate", String.class),
        ...
        COL360(360, "跟进次数", "collectTimes", Integer.class),
        COL370(370, "M值系数", "mVal", BigDecimal.class),
        ...
        COL1380(1380, "逾期天数", "overDays", Integer.class),
        ...
        COL1460(1460, "预计退案日", "expectTime", String.class),
    ...
    public enum CaseExportCaseConf {
        ...
        COL310("lastCall", "最后通电", "CONVERT(varchar(100), da.collect_date, 20) as collectDate", String.class),
        ...
        COL710("lastRepayDate", "最后还款日", "da.last_repay_date as lastRepayDate", String.class),
        ...
        COL1460("expectTime", "预计退案日", "da.expect_time as expectTime", String.class),
