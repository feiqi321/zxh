...
public class ExcelTelConstant {
    ...
    public enum CaseTel implements ExcelEnum{
        ...
        COL60(60, "*电话", "tel", DataCaseTelEntity.class, String.class),
        COL70(70, "*姓名", "name", DataCaseTelEntity.class, String.class),
        COL80(80, "电话类型", "type", DataCaseTelEntity.class, String.class),
        COL90(90, "关系", "relation", DataCaseTelEntity.class, String.class),
        COL100(100, "备注", "remark", DataCaseTelEntity.class, String.class),
        ;
