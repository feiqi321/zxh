...
public class ExcelCollectExportConstant {
    ...
    public enum CaseCollectExport implements ExcelEnum{
        ...
        COL410(131, "催收时间", "collectTime", String.class),
        ...
        COL260(260, "预计退案日", "expectTime", String.class),
        ...
        COL350(350, "催收员", "odv2", String.class),
    ...
    public enum CaseCollectExportConf{
        ...
        COL120("collectPhoneAddr", "电话/地址", "c.mobile as collectPhoneAddr", String.class),
        COL130("contractType", "联络类型", "c.tel_type as contractType", String.class),
        COL410("collectTime", "催收时间", "CONVERT(varchar(100), c.collect_time, 20) as collectTime", String.class),
        ...
        COL260("expectTime", "预计退案日", "t.expect_time as expectTime", String.class),
        ...
        COL350("odv2", "催收员", "c.odv as odv2", String.class),
